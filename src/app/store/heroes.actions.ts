...
export const updateHeroSuccess = createAction('[Heroes] Update Hero Success', props<{ payload: Hero }>());
export const updateHeroFail = createAction('[Heroes] Update Hero Fail', props<{ payload: any }>());
